...
variable frontends {
  ...
  default     = []
  description = "List of google_compute_address objects to be linked as ELB frontend."
}
...
variable internal_routes {
  type    = map(string)
  description = "name=>cidr map of routes to be introduced in external network"
  default = {}
}
